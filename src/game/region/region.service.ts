...
import { ApiError, DatabaseError } from 'src/errors';
...
export class RegionService {
  ...
  async updateRegions() {
    ...
    try {
      ...
      throw new DatabaseError('QUERY_FAILED', 'Failed to update regions', err);
    }
  }
  ...
  async countActive() {
    try {
      ...
      throw new DatabaseError('QUERY_FAILED', 'Failed to get regions', err);
    }
  }
  ...
  async fetchRegionLog(): Promise<RegionLog[]> {
    ...
    try {
      ...
      throw new DatabaseError('QUERY_FAILED', 'Failed to get region metadata', err);
    }
  }
  ...
  async updateRegionLog() {
    ...
    try {
      ...
      throw new DatabaseError('QUERY_FAILED', 'Failed to update region log', err);
    }
  }
  ...
  async getCurrentRegionLog() {
    try {
      ...
      throw new DatabaseError('QUERY_FAILED', 'Failed to get region log', err);
    }
  }
}
